...
const Header = () => {
  const navItems = [
    ...
    { text: "Business", icon: <Home size={18} /> },
    { text: "Financial Management", icon: <Home size={18} /> },
    { text: "Technology", icon: <Home size={18} /> },
    { text: "Customer Relations", icon: <Home size={18} /> },
    { text: "Quality", icon: <Home size={18} /> },
    { text: "About Us", icon: <Home size={18} /> },
  ];
